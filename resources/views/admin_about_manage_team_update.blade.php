						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">管理团队</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">管理团队设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/manage_team/doupdate/{{$team['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">成员id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="mid" type="text" value="{{$team['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="name" value="{{$team['name']}}" class="m-wrap huge" />

														<span class="help-inline">请输入成员姓名</span>
												...
												<div class="control-group">
													...
													<label class="control-label">成员职位</label>

													<div class="controls">

														<input type="text" name="position" value="{{$team['position']}}" class="m-wrap huge" />

														<span class="help-inline">请输入成员职位</span>
												...
												<div class="control-group">
													...
													<label class="control-label">成员照片路径</label>

													<div class="controls">

														<input type="text" name="picture" value="{{$team['picture']}}" class="m-wrap huge" />

														<span class="help-inline">请输入成员照片路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="introduction" value="{{$team['introduction']}}" class="m-wrap huge" />

														<span class="help-inline">请输入成员简介</span>
