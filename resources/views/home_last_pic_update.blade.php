						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">首页底部图片设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">底部图片设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/home/last_pic/doupdate/{{$last_pic['id']}}" class="form-horizontal" method="post">
												
												<div class="control-group">

													<label class="control-label">底部图片id</label>

													<div class="controls">   

														<input class="m-wrap huge" name="sid" type="text" value="{{$last_pic['id']}}" readonly/>

														<span class="help-inline">底部图片id</span>
												...
												<div class="control-group">
													...
													<label class="control-label">底部图片路径</label>

													<div class="controls">

														<input type="text" name="pic_path" value="{{$last_pic['pic_path']}}" class="m-wrap huge" />

														<span class="help-inline">请输入底部图片路径</span>
