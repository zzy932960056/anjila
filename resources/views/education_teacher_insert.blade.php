							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">安吉拉团队教师新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/education_teacher/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="name" placeholder="请输入教师姓名" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="position" placeholder="请输入教师职位" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="academy" placeholder="请输入教师毕业院校" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="photo" placeholder="请输入教师照片路径" class="m-wrap huge" />
