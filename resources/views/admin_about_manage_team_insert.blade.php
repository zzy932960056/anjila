						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">管理团队管理</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">管理团队新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/manage_team/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">管理人员姓名</label>

													<div class="controls">

														<input type="text" name="name" placeholder="请输入管理人员姓名" class="m-wrap huge" />

														<span class="help-inline">请输入管理人员姓名</span>
												...
												<div class="control-group">
													...
													<label class="control-label">管理人员职位</label>

													<div class="controls">

														<input type="text" name="position" placeholder="请输入管理人员职位" class="m-wrap huge" />

														<span class="help-inline">请输入管理人员职位</span>
												...
												<div class="control-group">
													...
													<label class="control-label">管理人员照片路径</label>

													<div class="controls">

														<input type="text" name="picture" placeholder="请输入管理人员照片路径" class="m-wrap huge" />

														<span class="help-inline">请输入管理人员照片路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">管理人员简介</label>

													<div class="controls">

														<input type="text" name="introduction" placeholder="请输入管理人员简介" class="m-wrap huge" />

														<span class="help-inline">请输入管理人员简介</span>
