					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/consultative_course/image_text">协商式课程管理</a> 
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">协商式课程</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">协商式课程设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/consultative_course/image_text/doupdate/{{$course['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">轮播图图片路径</label>

													<div class="controls">

														<input type="text" name="carousel_pic" value="{{$course['carousel_pic']}}" class="m-wrap huge" />

														<span class="help-inline">请输入轮播图图片路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">轮播图图片文本</label>

													<div class="controls">

														<input type="text" name="carousel_text" value="{{$course['carousel_text']}}" class="m-wrap huge" />

														<span class="help-inline">请输入轮播图图片文本</span>
