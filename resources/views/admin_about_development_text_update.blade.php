					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/development_text">发展历程文本管理</a> 
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">发展历程</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">发展历程设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/development_text/doupdate/{{$info['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">发展历程文本(pc端)</label>

													<div class="controls">

														<input type="text" name="history_text" value="{{$info['history_text']}}" class="m-wrap huge" />

														<span class="help-inline">请输入pc端发展历程文本</span>
												...
												<div class="control-group">
													...
													<label class="control-label">发展历程文本(移动端)</label>

													<div class="controls">

														<input type="text" name="history_text_yd" value="{{$info['history_text_yd']}}" class="m-wrap huge" />

														<span class="help-inline">请输入移动端发展历程文本</span>
