					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/consultative_course/paragraph">常青藤课程协商式课程</a> 
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/consultative_course/paragraph/doupdate/{{$course['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">常青藤课程协商式课程段落简介文本</label>

													<div class="controls">

														<input type="text" name="paragraph" value="{{$course['paragraph']}}" class="m-wrap huge" />

														<span class="help-inline">请输入常青藤课程协商式课程段落简介文本</span>
