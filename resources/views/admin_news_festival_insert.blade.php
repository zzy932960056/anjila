					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/news_festival">安吉拉动态管理(节日活动)</a> 

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">节日活动新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">节日活动管理</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">节日活动新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news_festival/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">动态中文名</label>

													<div class="controls">

														<input type="text" name="title_c" placeholder="请输入动态中文名" class="m-wrap huge" />

														<span class="help-inline">请输入动态中文名(必填)</span>
												...
												<div class="control-group">
													...
													<label class="control-label">动态英文名</label>

													<div class="controls">

														<input type="text" name="title_e" placeholder="请输入动态英文名" class="m-wrap huge" />

														<span class="help-inline">请输入动态英文名(选填)</span>
												...
												<div class="control-group">
													...
													<label class="control-label">动态封面图路径</label>
												...
												<div class="control-group">
													...
													<label class="control-label">动态时间</label>

													<div class="controls">

														<input type="text" name="date_time" placeholder="请输入动态时间" class="m-wrap huge" />

														<span class="help-inline">请输入动态时间(2017.01.01)</span>
