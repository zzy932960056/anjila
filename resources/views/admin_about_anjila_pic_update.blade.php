						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">关于我们轮播图</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">关于我们轮播图设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/about_us_pic/doupdate/{{$pic['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">关于我们轮播图id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="mid" type="text" value="{{$pic['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<label class="control-label">关于我们轮播图路径</label>

													<div class="controls">

														<input type="text" name="about_pic" value="{{$pic['about_pic']}}" class="m-wrap huge" />

														<span class="help-inline">请输入关于我们轮播图路径</span>
