					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>安吉拉教育理念</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$co->concept_index}}</td>

											<td>{{$co->concept_index_yd}}</td>

											<td><a href="/admin/education_concept/update/{{$co->id}}">编辑</a></td>
