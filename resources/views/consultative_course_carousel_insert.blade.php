							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">协商式课程图文新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/consultative_course/image_text/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">轮播图路径</label>

													<div class="controls">

														<input type="text" name="carousel_pic" placeholder="请输入轮播图路径" class="m-wrap huge" />

														<span class="help-inline">请输入轮播图路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">轮播图文本</label>

													<div class="controls">

														<input type="text" name="carousel_text" placeholder="请输入轮播图文本" class="m-wrap huge" />

														<span class="help-inline">请输入轮播图文本</span>
