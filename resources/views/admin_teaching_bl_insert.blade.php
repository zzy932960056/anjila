					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/teaching_bl">教学特色管理(布朗课程)</a> 
							...
							<li>
								...
								<a href="/admin/teaching_bl">布朗课程信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">布朗课程新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">布朗课程管理</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">布朗课程新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/teaching_bl/doinsert" class="form-horizontal" method="post">
