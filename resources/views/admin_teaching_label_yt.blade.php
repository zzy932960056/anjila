...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>课程标签列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a href="/admin/teaching_yt/label/details/{{$la->id}}">标签图文详情</a></td>

											<td><a href="/admin/teaching_yt/label/update/{{$la->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
			function(){
				var hid = $('#hidden').val();
				location.href = "/admin/teaching_yt/label/insert/"+hid;
			}
		)
		...
		$(".delete").click(
				function(othis){
					...
					var cid = $("#cid").html();
					$.ajax({
						url:"/admin/teaching_yt/label/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除课程标签成功');
								location.href = "/admin/teaching_yt/label/"+cid;
