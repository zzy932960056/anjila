...
<div class="container-fluid">
	<div class="container">
    	<div class="row">
            <p class="jxte_sanji_mbx">当前位置:<a href="/">首页</a>><a href="/teaching_yt">教学特色</a>><a href="{{$teaching[0]->a_link}}">{{$teaching[0]->course_sort}}</a>><a href="#">{{$teaching[0]->course_name_c}}</a></p>
		</div>
        <div class="row jxts_sanji_dafangzi">
        	<div class="col-md-12 col-sm-12 col-xs-12 jxts_sanji_xiaotu"><img src="{{URL::asset('/images/jxts_sanji_tu1.png')}}" class="img-responsive"></div>
            <div class="col-md-12 col-sm-12 col-xs-12 jxts_sanji_bt"><p><span>{{$teaching[0]->course_name_c}}<b>{{$teaching[0]->course_name_e}}</b></span></p></div>
