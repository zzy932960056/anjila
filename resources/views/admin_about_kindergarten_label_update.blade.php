						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">园所详情标签设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">园所详情标签设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/kindergarten/label/doUpdate/{{$label['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">园所详情标签ID</label>

													<div class="controls">   

														<input class="m-wrap medium" name="nid" type="text" value="{{$label['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<label class="control-label">园所详情标签名称</label>

													<div class="controls">

														<input type="text" name="label_name" value="{{$label['label_name']}}" class="m-wrap large" />

														<span class="help-inline">请输入园所详情标签名称</span>
												...
												<div class="control-group">
													...
													<label class="control-label">所属园所id</label>

													<div class="controls">

														<input type="text" name="mid" value="{{$label['kinder_id']}}" readonly class="m-wrap large" />
