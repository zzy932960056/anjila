					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>安吉拉文化封面图列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$in->cover_pic}}"/></td>

											<td>{{$in->cover_sort}}</td>

											<td><a href="/home/culture_cover/update/{{$in->id}}">编辑</a></td>
