					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/teaching_yt">亿童课程管理</a> 
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">亿童课程设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">亿童课程设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/teaching_yt/doupdate/{{$course['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" name="mid" type="text" value="{{$course['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<label class="control-label">课程中文名</label>

													<div class="controls">

														<input type="text" name="course_name_c" value="{{$course['course_name_c']}}" class="m-wrap huge" />

														<span class="help-inline">请输入课程中文名(必填)</span>
												...
												<div class="control-group">
													...
													<label class="control-label">课程英文名</label>

													<div class="controls">

														<input type="text" name="course_name_e" value="{{$course['course_name_e']}}" class="m-wrap huge" />

														<span class="help-inline">请输入课程英文名(选填)</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="course_cover_pic" value="{{$course['course_cover_pic']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="course_sort" value="{{$course['course_sort']}}" class="m-wrap huge" readonly/>
