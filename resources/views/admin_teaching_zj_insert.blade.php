					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/teaching_zj">教学特色管理(安吉拉早教)</a> 
							...
							<li>
								...
								<a href="/admin/teaching_zj">安吉拉早教信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">安吉拉早教新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">安吉拉早教管理</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">安吉拉早教新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/teaching_zj/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="course_name_c" placeholder="请输入课程中文名" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="course_name_e" placeholder="请输入课程英文名" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="course_cover_pic" placeholder="请输入封面图路径" class="m-wrap huge" />
