					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/teaching_yt">教学特色管理(亿童课程)</a> 
							...
							<li>
								...
								<a href="/admin/teaching_yt">亿童课程信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">亿童课程新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">亿童课程管理</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">亿童课程新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/teaching_yt/doinsert" class="form-horizontal" method="post">
