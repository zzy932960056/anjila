					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>常青藤课程理念基础</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a href="/admin/curriculum_idea/chart_text/update/{{$c->id}}">编辑</a></td>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_2">
									...
									<thead>
										...
										<tr>
											...
											<th>常青藤课程理念基础图片1路径</th>

											<th>常青藤课程理念基础图片1</th>

											<th>常青藤课程理念基础图片2路径</th>

											<th>常青藤课程理念基础图片2</th>

											<th>常青藤课程理念基础图片3路径</th>
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$c->pic1}}"></img></td>

											<td>{{$c->pic2}}</td>

											<td><img src="{{$c->pic2}}"></img></td>

											<td>{{$c->pic3}}</td>

											<td><img src="{{$c->pic3}}"></img></td>

											<td><a href="/admin/curriculum_idea/chart_pic/update/{{$c->id}}">编辑</a></td>
