					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/curriculum_idea/paragraph">常青藤课程理念基础管理</a> 
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/curriculum_idea/paragraph/doupdate/{{$paragraph['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap huge" name="bid" type="text" value="{{$paragraph['id']}}" disabled/>
												...
												<div class="control-group">
													...
													<label class="control-label">常青藤课程理念基础理念段落文本</label>

													<div class="controls">

														<input type="text" name="paragraph_idea" value="{{$paragraph['paragraph_idea']}}" class="m-wrap huge" />

														<span class="help-inline">请输入常青藤课程理念基础理念段落文本</span>
