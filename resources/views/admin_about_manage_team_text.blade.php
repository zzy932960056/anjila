					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/manage_team_text">管理团队</a> 
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>管理团队文本</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$in->manage_team_text}}</td>

											<td>{{$in->manage_team_text_yd}}</td>

											<td><a href="/admin/manage_team_text/update/{{$in->id}}">编辑</a></td>
