...
<div class="container-fluid tongyong_sanji_zhuti">
	<a href="{{$teaching[0]->a_link}}"><div class="col-md-12 col-sm-12 col-xs-12 tongyong_sanji_fanhui"><span><img src="{{URL::asset('/images_yd/sanji_zuojiantou.png')}}" class="img-responsive">{{$teaching[0]->course_sort}}</span></div></a>
	<div class="col-md-12 col-sm-12 col-xs-12 tongyong_sanji_zhuti_dafangzi">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 tongyong_sanji_bt"><p><span>{{$teaching[0]->course_name_c}}<b>{{$teaching[0]->course_name_e}}</b></span></p></div>
