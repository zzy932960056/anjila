					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>安吉拉团队</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$te->team_pic}}"></img></td>

											<td><img src="{{$te->team_pic_yd}}"></img></td>											

											<td><a href="/admin/education_team/update/{{$te->id}}">编辑</a></td>
