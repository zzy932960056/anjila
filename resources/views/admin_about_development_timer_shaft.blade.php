					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>发展历程时间轴</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$in->timer_shaft_pic}}</td>

											<td><img src="{{$in->timer_shaft_pic}}"></img></td>

											<td>{{$in->timer_shaft_year}}</td>

											<td>{{$in->kindergarten1}}</td>

											<td>{{$in->kindergarten2}}</td>

											<td><a href="/admin/development_timer_shaft/update/{{$in->id}}">编辑</a></td>
