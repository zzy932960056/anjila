...
<div class="container-fluid" id="main">
	<div class="container">
    	<!--课程介绍-->
    	<div class="row">
        	<div class="col-md-12 col-sm-12 col-xs-12 index_bt"><span>课程介绍<img src="{{URL::asset('/images/index_btjiantou.png')}}" class="img-responsive"></span>Course description</div>
			<div class="col-md-12 col-sm-12 col-xs-12 jxts_erji_zhuti">
                <div class="col-md-4 col-sm-4 col-xs-4 jxts_erji_zhuti_zuo">
                    <ul>
                        ...
                        <li class="jxts_erji_zhuti_zuo_li1">
                            <p><b class="jxts_erji_zhuti_zuo_li_b">亿童课程</b><br><span>Fun for kids</span></p>
                        ...
                        <li class="jxts_erji_zhuti_zuo_li2">
                            <p><b class="jxts_erji_zhuti_zuo_li_b">布朗课程</b><br><span>Kids brown</span></p>
                            <img src="{{URL::asset('/images/jxts_erji_jiantou2.png')}}" class="img-responsive">
                        </li>
                        </a>
                        <a href="/teaching_ys #main">
                        <li class="jxts_erji_zhuti_zuo_li3">
                            <p><b class="jxts_erji_zhuti_zuo_li_b">艺术创想</b><br><span>Art imagination</span></p>
                            <img src="{{URL::asset('/images/jxts_erji_jiantou3.png')}}" class="img-responsive">
                        </li>
                        </a>
                        <a href="/teaching_zj #main">
                        <li class="jxts_erji_zhuti_zuo_li4 jxts_erji_zhuti_zuo_li4_hua">
                            <p><b class="jxts_erji_zhuti_zuo_li_b jxts_erji_zhuti_zuo_li_b_hua">安吉拉早教</b><br><span>Early Child Development</span></p>
                ...
                <div class="col-md-8 col-sm-8 col-xs-8 jxts_erji_zhuti_you">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6" style="margin-right:0">
                    @endif
                        <div class="jxts_erji_zhuti_you_img_ceng"><img src="{{$v->course_cover_pic}}" class="jxts_erji_zhuti_you_img"></div>
                        <span>{{$v->course_name_c}}</span>
                    </div>
                    </a>
                    @endforeach
                </div>
