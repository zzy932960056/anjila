					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/teaching_ys">教学特色管理(艺术创想)</a> 
							...
							<li>
								...
								<a href="/admin/teaching_ys">艺术创想信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">艺术创想新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">艺术创想管理</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">艺术创想新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/teaching_ys/doinsert" class="form-horizontal" method="post">
