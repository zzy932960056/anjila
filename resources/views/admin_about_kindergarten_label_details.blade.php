...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>园所标签图文详情</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a href="/admin/kindergarten/label/details/text/update/{{$de->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/admin/kindergarten/label/details/pic/insert/"+hid;
				}
			)
		...
		$("#sample_editable_2_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/admin/kindergarten/label/details/text/insert/"+hid;
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/admin/kindergarten/label/details/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除图文成功');
								location.href = "/admin/kindergarten/label/details/"+label_id;
