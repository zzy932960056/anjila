								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/curriculum_idea/chart_pic/doupdate/{{$idea_pic['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap huge" name="bid" type="text" value="{{$idea_pic['id']}}" disabled/>
												...
												<div class="control-group">
													...
													<label class="control-label">理念基础图片1</label>

													<div class="controls">

														<input type="text" name="pic1" value="{{$idea_pic['pic1']}}" class="m-wrap huge" />

														<span class="help-inline">请输入理念基础图片1</span>
												...
												<div class="control-group">
													...
													<label class="control-label">理念基础图片2</label>

													<div class="controls">

														<input type="text" name="pic2" value="{{$idea_pic['pic2']}}" class="m-wrap huge" />

														<span class="help-inline">请输入理念基础图片2</span>
												...
												<div class="control-group">
													...
													<label class="control-label">理念基础图片3</label>

													<div class="controls">

														<input type="text" name="pic3" value="{{$idea_pic['pic3']}}" class="m-wrap huge" />

														<span class="help-inline">请输入理念基础图片3</span>
