					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/manage_team_text">管理团队文本</a> 

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">管理团队文本设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">管理团队文本</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">管理团队文本设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/manage_team_text/doupdate/{{$info['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">管理团队文本(pc端)</label>

													<div class="controls">

														<input type="text" name="manage_team_text" value="{{$info['manage_team_text']}}" class="m-wrap huge" />

														<span class="help-inline">请输入pc端管理团队文本</span>
												...
												<div class="control-group">
													...
													<label class="control-label">管理团队文本(移动端)</label>

													<div class="controls">

														<input type="text" name="manage_team_text_yd" value="{{$info['manage_team_text_yd']}}" class="m-wrap huge" />

														<span class="help-inline">请输入移动端管理团队文本</span>
