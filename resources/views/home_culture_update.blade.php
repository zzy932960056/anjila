					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/home/culture_cover">首页安吉拉文化</a> 

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">安吉拉文化封面图</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">安吉拉文化封面图设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">封面图设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/home/culture_cover/doupdate/{{$culture_cover['id']}}" class="form-horizontal" method="post">
												
												<div class="control-group">

													<label class="control-label">封面图id</label>

													<div class="controls">   

														<input class="m-wrap huge" name="sid" type="text" value="{{$culture_cover['id']}}" readonly/>

														<span class="help-inline">封面图id</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="cover_pic" value="{{$culture_cover['cover_pic']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<label class="control-label">封面图类别</label>

													<div class="controls">

														<input type="text" name="cover_sort" value="{{$culture_cover['cover_sort']}}" class="m-wrap huge" readonly/>
