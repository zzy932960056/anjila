						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">园所分部设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">园所分部设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/kindergarten/doupdate/{{$kinder['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">园所id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="mid" type="text" value="{{$kinder['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="kinder_cover" value="{{$kinder['kinder_cover']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="kinder_name" value="{{$kinder['kinder_name']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="kinder_address" value="{{$kinder['kinder_address']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="kinder_tel1" value="{{$kinder['kinder_tel1']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="kinder_tel2" value="{{$kinder['kinder_tel2']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<label class="control-label">是否首推(在安吉拉主页)</label>

													<div class="controls">

														<input type="radio" name="is_first" value="1" {{$kinder['is_first'] == '1'? 'checked' :''}} class="m-wrap large" />首推

														<input type="radio" name="is_first" value="0" {{$kinder['is_first'] == '0'? 'checked' :''}} class="m-wrap large" />不首推
												...
												<div class="control-group">
													...
													<label class="control-label">园所首推图路径</label>

													<div class="controls">

														<input type="text" name="first_picture" value="{{$kinder['first_picture']}}" class="m-wrap huge" />

														<span class="help-inline">请输入园所首推图路径</span>
