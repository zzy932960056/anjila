...
<div class="container-fluid jxte_zhuti" id="main">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 jxte_xuanxiangka_btn">
        ...
        <a href="/teaching_ys #main">
            <div class="col-md-3 col-sm-3 col-xs-3" style="border:1px solid #99c889;" id="jxte_xuanxiangka_btn3">艺术创想</div>
      	</a>
        <a href="/teaching_zj #main">
            <div class="col-md-3 col-sm-3 col-xs-3 jxte_xuanxiangka_btn_col3_4" style="margin-right:0; border:1px solid #eedd6c;" id="jxte_xuanxiangka_btn4">安吉拉早教</div>
        </a>
    </div>
