...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>布朗课程列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a href="/admin/teaching_bl/label/{{$co->id}}">课程详情</a></td>

											<td><a href="/admin/teaching_bl/update/{{$co->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
			function(){
				location.href = "/admin/teaching_bl/insert";
			}
		)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/admin/teaching_bl/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除课程成功');
								location.href = "/admin/teaching_bl";
