...
<div class="container-fluid jxte_zhuti">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 jxte_xuanxiangka_btn">
        ...
        <a href="/news_jr #main">
            <div class="col-md-3 col-sm-3 col-xs-3" style="border:1px solid #e78f8c;" id="jxte_xuanxiangka_btn2">节日活动</div>
      	</a>
        <a href="/news_bj #main">
            <div class="col-md-3 col-sm-3 col-xs-3" style="border:1px solid #99c889;" id="jxte_xuanxiangka_btn3">班级活动</div>
      	</a>
        <a href="/news_fm #main">
            <div class="col-md-3 col-sm-3 col-xs-3 jxte_xuanxiangka_btn_col3_4" style="margin-right:0; border:1px solid #eedd6c;" id="jxte_xuanxiangka_btn4">父母沙龙</div>
        </a>
    </div>
    
    <div class="col-md-12 col-sm-12 col-xs-12 jxte_mianban" id="jxte_mianban1">
        @foreach($news_fm as $k => $v)
