						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">安吉拉文化标签新增</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">安吉拉文化标签新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/culture/label/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">文化标签</label>

													<div class="controls">

														<input type="text" name="label_name" placeholder="请输入文化标签" class="m-wrap large" />

														<span class="help-inline">请输入文化标签</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="culture_id" value="{{$culture_id}}" readonly class="m-wrap large" />
