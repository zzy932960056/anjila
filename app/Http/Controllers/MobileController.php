...
{   
    ...
    public function index(){
    	$data = [];
        //banner
        $banner = DB::table('anjila_banner')->get();
        $data['banner'] = $banner;
        //安吉拉文化
    ...
    public function teaching_yt(){
        ...
        return view('yd_jiaoxuetese_yt_erji',$data);
    }
    ...
    public function teaching_bl(){
        ...
        return view('yd_jiaoxuetese_bl_erji',$data);
    }
    ...
    public function teaching_ys(){
        ...
        return view('yd_jiaoxuetese_ys_erji',$data);
    }
    ...
    public function teaching_zj(){
        ...
        return view('yd_jiaoxuetese_zj_erji',$data);
    }
    ...
    public function teaching_details($id){
        ...
        return view('yd_jiaoxuetese_sanji',$data);
    }
    ...
    public function culture(){
        ...
        $data['speak'] = $speak;
        return view('yd_anjilawenhua_erji',$data);
    }
    ...
    public function culture_details($id){
        ...
        $data['label_details'] = $label;
        return view('yd_anjilawenhua_sanji',$data);
    }
    ...
    public function news_sh(){
        ...
        return view('yd_yuansuodongtai_sh_erji',$data);
    }
    ...
    public function news_jr(){
        ...
        return view('yd_yuansuodongtai_jr_erji',$data);
    }
    ...
    public function news_bj(){
        ...
        return view('yd_yuansuodongtai_bj_erji',$data);
    }
    ...
    public function news_fm(){
        ...
        return view('yd_yuansuodongtai_fm_erji',$data);
    }
    ...
    public function news_details($id){
        ...
        return view('yd_yuansuodongtai_sanji',$data);
    }
    ...
    public function curriculum(){
        ...
        return view('yd_changqingtengkecheng',$data);
    }
    ...
    public function about(){
        ...
        $anjila_team = DB::table('anjila_team')->orderBy('id','asc')->get();
        $a = count($anjila_team);
        $ar = [];
        $y = 0;
        for($x=1;$x<=$a;$x++){
            $f = array_shift($anjila_team);
            $ar[$y][$x] = $f;
            if(is_int($x/2)){
                $y++;
            }
        ...
        return view('yd_guanyuwomen',$data);
    }
    ...
    public function about_details($id){
        ...
        $data['label_details'] = $label;
        return view('yd_guanyuwomen_sanji',$data);
    }
